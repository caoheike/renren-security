 ...
 */
@Mapper
public interface CreditDao extends BaseMapper<TokenEntity> {
    ...
    int lockIp(String ip,String status);
    ...
    Map<String,Object> quertyData(String userCard,String userType);
