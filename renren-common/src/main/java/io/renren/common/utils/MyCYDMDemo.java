...
public class MyCYDMDemo {
    ...
    // 下载云DLL http://yundama.com/apidoc/YDM_SDK.html#DLL
...
//        String appkey = "22cc5376925e9387a23cf797cb9ba745";
        int appid = 8289;
    	String appkey = "b1a2ccbe15b7634369278de45a922322";
        // 图片路径
        ...
        // 只需要在初始的时候登陆一次
        int uid = 0;
        YDM ydm = YDM.INSTANCE;
        ydm.YDM_SetAppInfo(appid, appkey);            // 设置软件ID和密钥
